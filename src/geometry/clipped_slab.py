...
# slab defaults to x=y= 0.0..1.0
# clip the slab to x range 0.3..0.9 
clip1 = ifcopenshell.util.data.Clipping(location=(0.3, 0.0, 0.0), normal=(-1.0, 0.0, 0.0))
clip2 = ifcopenshell.util.data.Clipping(location=(0.9, 0.0, 0.0), normal=(1.0, 0.0, 0.0))

clippings = [clip1, clip2]
...
# Write out to a file
ifcfile.write("./output/geometry_clipped_slab1.ifc")
