...
# Get `extrude` to do more work rather than rotating the shape afterwards
...
project = ifcopenshell.api.root.create_entity(file=ifcfile, 
                                              ...
                                              name="Wall With Opening Project-2")
...
# placement in mm
placement_wall1 = make_placement_matrix(position=V(0.0, 0.0, 0.0))
...
opening_placement = make_placement_matrix(V(300.0, 0.0, 0.0))
...
# Write out to a file
ifcfile.write("./output/wall_with_opening2.ifc")
