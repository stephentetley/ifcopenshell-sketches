...
project = ifcopenshell.api.root.create_entity(file=ifcfile, 
                                              ...
                                              name="AddBoolean Block_Cylinder Difference Project")
...
block1 = builder.block(position=V(-40, -40, 0), 
                       x_length=80.0,
                       y_length=80.0,
                       z_length=12.0)
...
booleans = ifcopenshell.api.geometry.add_boolean(file=ifcfile,
                                      first_item=block1,
                                      second_items=[cylinder1],
                                      operator='INTERSECTION')

representation = builder.get_representation(context=body, items=[block1, cylinder1])
...
# Write out to a file
ifcfile.write("./output/add_boolean_block_cylinder_difference1.ifc")
