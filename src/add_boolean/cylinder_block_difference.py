...
project = ifcopenshell.api.root.create_entity(file=ifcfile, 
                                              ...
                                              name="AddBoolean Cylinder_Block Difference Project")
...
block1 = builder.block(position=V(-20, -20, 0), 
                       x_length=40.0,
                       y_length=40.0,
                       z_length=12.0)
...
representation = builder.get_representation(context=body, items=[cylinder1, block1])
...
# Write out to a file
ifcfile.write("./output/add_boolean_cylinder_block_difference1.ifc")
